...
<nav class="white navbar-main header-background" role="navigation">
    <div class="nav-wrapper container">
        ...
        <ul class="right hide-on-med-and-down">
            <li style="color:white"class=" my-account-item"><span  class=" user-text">Bienvenido  <?php echo $_SESSION['username'] ?></span><a class="waves-effect waves-light material-icons" href="login.php"><i class="material-icons white-text">account_circle</i></a></li>
